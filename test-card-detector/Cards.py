...
CARD_RATIO_LONG_2_SHORT = 6.5 / 5.0
CARD_WARP_WIDTH=200
CARD_WARP_HEIGHT=int(200 * CARD_RATIO_LONG_2_SHORT)
...
def find_cards(thresh_image, image):
    ...
    for i in range(len(cnts_sort)):
        ...
        hull = cv2.convexHull(cnts_sort[i])
...
def flattener(image, pts, w, h):
    ...
    maxWidth = CARD_WARP_WIDTH
    maxHeight = CARD_WARP_HEIGHT
